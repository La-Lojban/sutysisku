...
var socket_io = __webpack_require__(819);
...
const initBackend = makeInitBackend('__absurd:spawn-idb-worker', () =>
  __webpack_require__.e(/* import() */ 403).then(__webpack_require__.bind(__webpack_require__, 403))
);
...
function RenderDasri({ seskari, sepia }) {
  ...
  if (state.displaying.bangu === 'muplis') {
    ...
    content.className = "content content-muplis"
  } else {
    document.getElementById('leitutci').style.display = 'flex'
    content.className = "content content-sutysisku"
  }
