...
var socket_io = __webpack_require__(6546);
...
const initBackend = makeInitBackend('__absurd:spawn-idb-worker', () =>
  __webpack_require__.e(/* import() */ 920).then(__webpack_require__.bind(__webpack_require__, 920))
);
...
const worker = new Worker('worker.js?sisku=1652011600220')
initBackend(worker)
...
async function skicu_palodovalsi({
  def,
  inner,
  query,
  seskari,
...
function zgana_sihesle() {
  ...
  if (day >= 340 || day < 10) {
    ...
    elemDiv.innerHTML = `<div class="leisihesle" aria-hidden="true">${Array(3)
      .fill(['❅', '❆'])
      .flat()
      .map((_) => {
        const rnd40 = rnd(30)
